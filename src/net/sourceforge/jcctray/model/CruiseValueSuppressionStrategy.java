...
public class CruiseValueSuppressionStrategy extends ValueSuppressionStrategy {

	public boolean suppressAttribute(AttributeDescriptor arg0, String arg1) {
		return false;
	}
	...
	public boolean suppressElement(ElementDescriptor element, String namespaceUri, String localName,
		...
		return "cruise".equals(localName) ? true : false;
	}
